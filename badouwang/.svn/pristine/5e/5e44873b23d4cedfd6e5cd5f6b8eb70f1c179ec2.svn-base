jQuery(function($) {
			var iPagerCount=5;
			var iPageNumber=0;
			var aTop=[0,500,1000,1500,2000,2500,3000];
			...
			$("html").niceScroll({
				touchbehavior:false,cursorcolor:"#11A583",cursoropacitymax:1,cursorwidth:6,horizrailenabled:true,cursorborderradius:5,autohidemode:true,background:'none',cursorborder:'solid 1px #0966ce'
			});
