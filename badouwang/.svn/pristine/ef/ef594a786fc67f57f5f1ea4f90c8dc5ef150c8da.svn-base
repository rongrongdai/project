...
class  AuthenticationAction extends CommonAction{
    ...
    public  function index(){
      ...
      $sql = "SELECT u.uname,c.name,a.* FROM bd_authentication a JOIN bd_user u ON a.uid=u.uid LEFT JOIN bd_city c ON c.id=a.city WHERE $condition1";
    ...
    public  function verify(){
        ...
        if($idarr['sid']){
            ...
            if($res){//更新身份
                ...
                $type_id = $type_id==5?$type_id:$type_id + 1;
