   ...
   <div class="dails-one">
      ...
      <div class="dails-oy">
          ...
          <ul>
            ...
            <?php if(is_array($cname)): foreach($cname as $key=>$data): ?><li class="wda"><?php echo ($data["name"]); ?></li><?php endforeach; endif; ?>
          </ul>
          
        </div>
          
         <div class="syiy">
        <?php if(is_array($courses)): foreach($courses as $key=>$course): ?><div class="ptw-kc">
                <img src="__ROOT__/public/images/home/pxu/008.gif" class="pyw-kim" />
                <p class="ptw-k-a"><span><?php echo ($course["city"]); ?></span><?php echo ($course["cname"]); ?></p>
                <p class="ptw-k-b">￥<?php echo ($course["d_price"]); ?>起 <span>详情</span><span name="collect" cid="<?php echo ($course["id"]); ?>">收藏</span></p>
                <p class="ptw-k-c">上课地址：<?php echo ($course["o_address"]); ?></p>
                <p class="ptw-k-d">时间：<?php echo (date("Y-m-d",$course["s_time"])); ?></p>
      ...
      <div class="dails-oe">
          ...
          <p class="pt-rs" ></p>
          <div class="pt-rsw"><img src="__ROOT__/public/images/home/pxu/011.gif" /></div>
      
      </div>
   </div>
<div style='clear:both;margin-top:100px; padding-bottom:40px;'><?php echo ($pages); ?></div> 
</div>
