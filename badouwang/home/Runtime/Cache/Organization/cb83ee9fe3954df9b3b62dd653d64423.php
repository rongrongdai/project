...
<div class="per">
    <div class="per-top">
         <img src="__ROOT__/public/images/home/kcgl1.jpg" />
...
<script>
                 ...
                 function loadData(page){
                     $.get("__ROOT__/index.php/Ajax/AjaxCourse/getCourse?page="+page,function(data){
                        var res=eval('('+data+')');
                        if(res){
                            ...
                            for(i in res.entities){
                               ...
                               '<td width="10%">'+res.entities[i].cid+'</td>';
                                item+='<td width="10%" name=intr>'+res.entities[i].introduce+'</td>';
                                item+='<td width="15%">'+res.entities[i].uname+'</td>';
                                var img=res.entities[i].c_img!=false?'<img onerror="javascript:this.src='+"'"+'__ROOT__/public/images/home/n_pic.png'+"';"+'"'+'  src="__ROOT__'+res.entities[i].c_img+'" width ="150" />':'';
                                item+='<td width="10%" name="des">'+res.entities[i].descript+'</td>'+'<td width="10%">'+res.entities[i].price+'</td>'+'<td width="10%">'+img+'</td>';
                                item+='<td width="10%"> <a href="modifyCourse?id='+res.entities[i].id+'">修改课程</a> <br/><a href="delCourse?id='+res.entities[i].id+'">删除</a></td></tr>';
