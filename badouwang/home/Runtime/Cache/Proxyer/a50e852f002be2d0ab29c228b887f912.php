		...
		<div class="pheig">
 		...
 		<div class="pheig">
                    ...
                    <div class="pflat2 pflat2tx">
                          ...
                          <?php if($data["c_img"] != ''): ?><img onerror="javascript:this.src='__ROOT__/public/images/home/n_pic.png';"  src="__ROOT__<?php echo ($data["c_img"]); ?>"><?php endif; ?>
