          ...
          <div class="spxz-two" style="display:block;" name="spone">
              <!-- <p>我的爱好：<a href="#"><span>预览</span></a></p>-->
               <div class="spxz-ty">
                     ...
                     <input type="text" class="sbiaoq"  value="<?php echo ($labs['lab']); ?>" placeholder="请输入你属于你的独特标签" readonly name="lval"/><br />
...
<script src="__ROOT__/public/js/layer/layer-min.js"></script>
            ...
            <script>
                var priv="<?php echo ($priv); ?>";
                var lable="";
                var selLable="<?php echo ($labs['lab']); ?>";
                var lables=[];
                var page=1;
                var hobs=[];
