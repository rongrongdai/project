...
<!--我的培训-->
 <div class="sp-er-center">
           <div class="mtrain-centeyi">
               <div class="mtra-ce-yi mtrp" <?php if(($user["type"] == '2') OR ($user["type"] == '4')): ?>style="display:block;"<?php else: ?>style="display:none;"<?php endif; ?>>
                 <p>我发布的家教</p>
                 <div class="mtsjx dshan"></div>
              </div>
              
              <div class="mtra-ce-yi" <?php if(($user["type"] == '2') OR ($user["type"] == '4')): ?>style="display:block;"<?php else: ?>style="display:block;"<?php endif; ?>>
                 <p>我的收藏</p>
                 <div class="mtsjx"></div>
              </div>
           </div>
         ...
         <div class="mtrain-centeer">
              <?php if(is_array($datas)): foreach($datas as $key=>$tech): ?><div class="matr-ce-two">
                  
                   <div class="matr-y"><img onerror="javascript:this.src='__ROOT__/public/images/home/n_pic.png';"  src="<?php if($tech["c_img"] != ''): ?>__ROOT__/<?php echo ($tech["c_img"]); else: ?>__ROOT__/public/images/home/n_pic.png<?php endif; ?>" width='131'/></div>
                        <div class="matr-er">
                           <div class="matr-e">
                               <p><?php echo ($tech["title"]); ?></p>
                               <span>
                                   <?php echo ($tech["introduce"]); ?>
                               </span>
                           </div>
...
<!--热门培训课程-->
 <div class="sp-er-righty">
      ...
      <div class="ma-rter">
          <?php if(is_array($hdatas)): foreach($hdatas as $key=>$teach): ?><div class="ma-rter-yi">
             <?php if($teach["c_img"] != ''): ?><img onerror="javascript:this.src='__ROOT__/public/images/home/n_pic.png';"  src="__ROOT__<?php echo ($teach["c_img"]); ?>" /><?php endif; ?>
             ...
             <div class="ma-yice" style="display:block;"> <span><?php echo ($teach["title"]); ?></span></div>
         </div><?php endforeach; endif; ?>
      </div>
 </div>
