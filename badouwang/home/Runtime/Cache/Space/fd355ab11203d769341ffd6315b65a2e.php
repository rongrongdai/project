...
<!--我的培训-->
 <div class="sp-er-center">
         ...
         <div class="mtrain-centeer">
             <?php if(is_array($datas)): foreach($datas as $key=>$course): ?><div class="matr-ce-two">
                   <div class="matr-y"><img onerror="javascript:this.src='__ROOT__/public/images/home/n_pic.png';"  src="<?php if($course["c_img"] != ''): ?>__ROOT__<?php echo ($course["c_img"]); else: ?>__ROOT__/public/images/home/n_pic.png<?php endif; ?>" width='131'/></div>
                        <div class="matr-er">
                           <div class="matr-e">
                               <p><?php if($course["aname"] != ''): echo ($course["aname"]); else: echo ($course["cname"]); endif; ?></p>
                               <span>
                                   <?php echo (html_entity_decode($course["descript"])); ?>
                               </span>
                           </div>
                            <div class="map-bj"><p><a href='__ROOT__/index.php/Organ/Organ/odetail?id=<?php echo ($course["id"]); if($course["type"] == 2): ?>&type=2<?php else: ?>&type=1<?php endif; ?>'>查看详情</a></p></div>
                       </div>
...
<!--热门培训课程-->
 <div class="sp-er-righty">
      ...
      <div class="ma-rter">
          <?php if(is_array($hdatas)): foreach($hdatas as $key=>$course): ?><div class="ma-rter-yi">
             <?php if(course.c_img != ""): ?><img onerror="javascript:this.src='__ROOT__/public/images/home/n_pic.png';"  src="__ROOT__<?php echo ($course["c_img"]); ?>" width="259"/><?php endif; ?>
             ...
             <div class="ma-yice"> <span><?php echo ($course["aname"]); ?></span></div>
         </div><?php endforeach; endif; ?>
      </div>
