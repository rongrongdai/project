...
<div class="for-lby-two">
    <div class="ft-rit">
        ...
        <?php if(is_array($ask)): foreach($ask as $key=>$vo): ?><div class="ft-rone"> <a href="__URL__/qlist?cid=<?php echo ($vo["id"]); ?>">
     ...
     <div class="ft-cen">
      ...
      <div id="hot">    
      <?php if(is_array($questions)): foreach($questions as $key=>$vo): ?><div class="ft-ceei">
              <div class="ft-ceei-r"><p>问</p></div>
              <div class="ft-ceei-l">
                 <p class="dz"><?php echo (strip_tags($vo["content"])); ?></p>
                 <p class="xz"><?php echo ($vo["asw"]); ?>...   <a href="__APP__/Space/Question/answerdetail?tid=<?php echo ($vo["id"]); ?>" class="au">[详情]</a> </p>
              </div>
         </div><?php endforeach; endif; ?>
      </div>
      <div id="noasw" style="display:none;">    
      <?php if(is_array($noanswer)): foreach($noanswer as $key=>$vo): ?><div class="ft-ceei">
              <div class="ft-ceei-r"><p>问</p></div>
              <div class="ft-ceei-l">
                 <p class="dz"><?php echo ($vo["content"]); ?>......</p>
                 <p class="xz"><a href="__APP__/Space/Question/answerdetail?tid=<?php echo ($vo["id"]); ?>" class="au">[我要抢答]</a> </p>
              </div>
         </div><?php endforeach; endif; ?>
      </div>
     ...
     <div class="ft-lft">
          ...
          <div class="ft-lfsar">
             <img onerror="javascript:this.src='__ROOT__/public/images/home/n_pic.png';"  src="__ROOT__/public/images/home/xueba/015.gif" class="imgsw"/>
                 ...
                 <div class="ft-lsy">
                     <?php if(is_array($rqes)): foreach($rqes as $key=>$qes): ?><div class="phb">
                            <p class="oe"><?php echo ($key+1); ?></p>
                            <p class="osw"><a href="__APP__/Space/Question/answerdetail?tid=<?php echo ($qes["id"]); ?>"><?php echo (mb_substr(strip_tags($qes["content"]),"0","8","utf-8")); ?>...</a></p>
                        </div>
                         <?php $rate=ceil($qes['aswnum']/$qes['suma']*100); ?>
                        <p class="phh" ><span style='margin-right: 20px;margin-left:0px;'><?php if($qes["aswnum"] > 0): echo ($qes["aswnum"]); else: ?>0<?php endif; ?></span><?php if($qus.aswnum): echo ($rate); else: ?>0<?php endif; ?>%</p><?php endforeach; endif; ?>
