...
<div class="content">
    <div class="order_wrap">
        ...
        <ul>
            <li>
                <img style="float:left;" onerror="javascript:this.src='__ROOT__/public/images/home/n_pic.png';"  src="__ROOT__/<?php echo ($data["c_img"]); ?>" width="70px" height="70px" />
                <div class="tname"><p><?php echo ($data["real_name"]); ?></p><span id="price"><?php echo ($data["price"]); ?></span>元/课时</div>
            </li>
            <div style="clear:both;"></div>
            <li><span>教学科目及上课方式：</span> <input name="course" value="<?php echo ($data["gname"]); echo ($data["fname"]); ?>" readOnly />
            	<select name="place">
            ...
            <li>学生姓名： <input name="stu_name" value="<?php echo (session('uname')); ?>" /></li>
            <li>上课地址： <input name="address" value="<?php echo ($data["address"]); ?>" /></li>  
        ...
        <div class="nav"></div> 
        <ul class="pay">
            <li>订单金额：<span>￥</span><span id="pay"><?php echo ($data["price"]); ?></span><span>.00</span></li>
            <input type="hidden" name="money" value="<?php echo ($data["price"]); ?>" />
            <input type="hidden" name="course_id" value="<?php echo ($data["id"]); ?>" />
            <input type="hidden" name="tuid" value="<?php echo ($data["teacher_id"]); ?>" />
...
<script type="text/javascript">
    var num = $("#time").val(),pay = parseInt($("#price").text());
    $("#minus").click(function(){
        num--;var payD = parseInt($("#pay").text());
