...
<div class="pwid">
    ...
    <div class="roll">
        ...
        <div id='roll'>
        	<?php if(is_array($hot)): foreach($hot as $i=>$vo): ?><a href="__URL__/teachDetail?pid=<?php echo ($vo["id"]); ?>">
                	<img  src="__ROOT__<?php echo ($vo["c_img"]); ?>" width="100%" height="100%" />
                    <div class="ptli">
    ...
    <!------------------------------------>
    <div class="list">
    	<div class="sous">搜索到 <span class="sz"><?php echo ($sum); ?></span> 个相差家教<span class="jg">价格:<img  id="jgimg" src="__ROOT__/public/images/home/jiantou.png" width="20" height="20" onclick="km('pin',this.id)" alt="pin" /></span></div>
	  
        <div class="souswy"></div>
      
	  <div id="seek">
        <?php if(is_array($data)): foreach($data as $i=>$vo): ?><a href="__URL__/teachDetail?pid=<?php echo ($vo["id"]); ?>">
	        <div class="tent">
	        	<img  class="tentimg" src="__ROOT__<?php echo ($vo["c_img"]); ?>"/>
	        	<div class="ent">
	            	<p><span class="yax"><?php echo ($vo["real_name"]); ?></span>  评分:
                    <img  src="__ROOT__/public/images/home/pxu/sjxpx.png" />
                    <img  src="__ROOT__/public/images/home/pxu/sjxpx.png" />
                    <img  src="__ROOT__/public/images/home/pxu/sjxpx.png" />
                    <img  src="__ROOT__/public/images/home/pxu/sjxpx.png" />
                    <img  src="__ROOT__/public/images/home/pxu/sjxpx.png" />
                   5分
                    ...
                    <p class="py">思维引导，寓教于乐。</p>
                    <p><img  src="__ROOT__/public/images/home/pxu/002.png" class="imd" />科目：小学/数学初中/数学初中/英语高中/.....</p>
                    <p><img  src="__ROOT__/public/images/home/pxu/002.png" class="imd"/>教龄：1年   课时：136.0时</p>
                    <p><img  src="__ROOT__/public/images/home/pxu/002.png" class="imd"/>区域：<?php echo ($vo["address"]); ?></p> 
                    <p class="hed"><span>亲切</span> <span>负责</span> <span>良师益友</span></p>
	            </div>
                
                <div class="enty">
                   <p>￥<strong class="price"><?php echo ($vo["price"]); ?>.00</strong> 元 / 小时</p>
    ...
    <div class="tising">
      ...
      <?php if(is_array($newtch)): foreach($newtch as $key=>$vv): ?><div class="tisero">
          <a href="__APP__/Space/Space/space?uid=<?php echo ($vv["id"]); ?>"><img onerror="javascript:this.src='__ROOT__/public/images/home/n_pic.png';"  src="__ROOT__<?php echo ($vv["self_img"]); ?>" class="img"/></a>
          <div class="yeo">
          <p><a href="__APP__/Space/Space/space?uid=<?php echo ($vv["id"]); ?>"><?php echo ($vv["real_name"]); ?></a>教龄:30年以上</p>
          <p><?php echo ($vv["cname"]); ?>/<?php echo ($vv["gname"]); ?></p>
          </div>
